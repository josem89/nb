...
def main(is_test_run):
    ...
    query = extract_connector_param(siemplify, param_name="Query", is_mandatory=True, print_value=True)
    ...
    try:
        ...
        for alert in filtered_alerts:
            try:
                ...
                siemplify.LOGGER.info(f"Alert {alert.id} was created with date {alert.date}.")
        ...
        if not is_test_run:
            ...
            save_timestamp(siemplify=siemplify, alerts=fetched_alerts, timestamp_key="creation_date")
